...
{
    public abstract class HospitalBasicoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HospitalBasicoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HospitalBasicoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HospitalBasicoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HospitalBasicoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HospitalBasicoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HospitalBasicoDbContext, Task<T>> func)
        {
            T result;
